...
namespace Queries.Informations.News.GetFullListNews;

/// <summary>
/// Получение полного списка новостей
/// </summary>
public class GetFullListNews : IGetFullListNews
{
    ...
    public string BuilderUrl(string? search)
    {
        ...
        if (ValidateConfiguration())
        {
            ...
            string url = _configuration.GetValue("DefaultConnection") + _configuration.GetValue("Api")
                + _configuration.GetValue("News") + "fullList" + CreateQueryString(search);
